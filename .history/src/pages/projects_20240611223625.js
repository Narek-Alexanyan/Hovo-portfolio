        ...
        <Layout className="pt-16">
          ...
          <div className="grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0">
            ...
            <div className="col-span-12">
              <FeaturedProject
                type="Website"
                title="Promote Your Videos to a Targeted Audience"
                summary="AlphaVoice makes it easier to manage your video-email campaigns. From our prospecting database to video-marketing funnels that convert, we’ve got you covered."
                img={proj4}
